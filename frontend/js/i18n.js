...
(function (global) {
  ...
  const translations = {
    'zh-CN': {
      ...
      pipeline_name: '流水线名称',
      placeholder_pipeline_name: '如：信贷审批知识萃取',
      business_domain: '业务领域',
      placeholder_business_domain: '如：信贷、风控、营销（默认同场景名称）',
      preset_scenario: '-- 选择预设场景 --',
      new_pipeline: '新建流水线',
      create_and_start: '创建并开始',
      np_name_required: '请输入流水线名称',
      np_scenario_required: '请选择或输入场景名称',
      preview_prefix: '预览：',
      modified_unsaved: '已修改（未保存）',
      step1_scenario_name_required: '请填写场景名称',
      ...
      autosave_failed: '保存失败，点击重试',
      excel_unmodified: '未修改',
      excel_save_no_path: '无源文件路径，请重新上传',
      excel_saving: '保存中...',
      excel_saved: '已保存',
      save: '保存',
      excel_save_failed: '保存失败',
      ...
      skill_detail_detailed_description: '📖 详细说明',
      skill_detail_business_value: '💡 业务价值',
      skill_detail_usage_guide: '📋 使用步骤',
      skill_detail_input_example: '📥 输入示例',
      skill_detail_output_example: '📤 输出示例',
      skill_detail_input_output: '🔧 输入 / 输出',
      skill_detail_applicable_scenarios: '✅ 适用场景',
      skill_detail_capabilities: '🏷️ 核心能力',
      skill_detail_supported_formats: '📂 支持格式',
      skill_detail_output_styles: '🎨 输出风格',
      skill_detail_triggers: '🔍 触发条件',
      skill_detail_limitations: '⚠️ 局限性',
      skill_detail_max_file: '📦 最大文件',
      skill_detail_version: '🔖 版本',
      skill_detail_related_step: '📌 关联步骤',
      skill_enabled: '已启用',
      skill_disabled: '已禁用',
      skill_no_registered: '暂无已注册的 Skill',
      skill_registered: '已注册技能',
      skill_load_failed: '加载失败',
      skill_network_error: '网络错误',
      skill_loading_detail: '加载详情...',
      operation_failed: '操作失败',
      unknown_error: '未知错误',
      load_model_failed: '加载模型失败',
      model_no_config: '暂无模型配置',
      model_badge_preset: '预设',
      model_badge_custom: '自定义',
      model_badge_ccb: '建行',
      model_badge_openai: 'OpenAI',
      model_key: 'Key:',
      model_edit: '编辑',
      model_test_connection: '测试连接',
      model_stream_test: '流式测试',
      model_delete: '删除',
      model_select_placeholder: '-- 选择模型 --',
      model_select_skill_placeholder: '-- 选择 Skill --',
      model_streaming: '流式中...',
      model_testing: '测试中...',
      model_stream_connect_prefix: '流式连接',
      model_connecting_prefix: '正在连接',
      model_stream_complete_prefix: '流式完成: ',
      model_empty_response: '(空)',
      model_connection_ok: '连接成功',
      ...
      model_save_failed: '保存失败',
      model_add_failed: '添加失败',
    ...
    en: {
      ...
      edit_preset_model: 'Edit Preset Model',
      ...
      placeholder_pipeline_name: 'e.g. Credit Approval Knowledge Extraction',
      business_domain: 'Business Domain',
      placeholder_business_domain: 'e.g. credit, risk, marketing (defaults to scenario name)',
      preset_scenario: '-- Select Preset Scenario --',
      new_pipeline: 'New Pipeline',
      create_and_start: 'Create & Start',
      np_name_required: 'Please enter pipeline name',
      np_scenario_required: 'Please select or enter scenario name',
      preview_prefix: 'Preview: ',
      modified_unsaved: 'Modified (unsaved)',
      step1_scenario_name_required: 'Please enter scenario name',
      ...
      autosave_failed: 'Save failed, click to retry',
      excel_unmodified: 'Unmodified',
      excel_save_no_path: 'No source file path, please re-upload',
      excel_saving: 'Saving...',
      excel_saved: 'Saved',
      save: 'Save',
      excel_save_failed: 'Save failed',
      ...
      skill_detail_detailed_description: '📖 Detailed Description',
      skill_detail_business_value: '💡 Business Value',
      skill_detail_usage_guide: '📋 Usage Guide',
      skill_detail_input_example: '📥 Input Example',
      skill_detail_output_example: '📤 Output Example',
      skill_detail_input_output: '🔧 Input / Output',
      skill_detail_applicable_scenarios: '✅ Applicable Scenarios',
      skill_detail_capabilities: '🏷️ Core Capabilities',
      skill_detail_supported_formats: '📂 Supported Formats',
      skill_detail_output_styles: '🎨 Output Styles',
      skill_detail_triggers: '🔍 Triggers',
      skill_detail_limitations: '⚠️ Limitations',
      skill_detail_max_file: '📦 Max File',
      skill_detail_version: '🔖 Version',
      skill_detail_related_step: '📌 Related Step',
      skill_enabled: 'Enabled',
      skill_disabled: 'Disabled',
      skill_no_registered: 'No Skills registered yet',
      skill_registered: 'Registered Skills',
      skill_load_failed: 'Load failed',
      skill_network_error: 'Network error',
      skill_loading_detail: 'Loading detail...',
      operation_failed: 'Operation failed',
      unknown_error: 'Unknown error',
      load_model_failed: 'Failed to load model',
      model_no_config: 'No model configuration',
      model_badge_preset: 'Preset',
      model_badge_custom: 'Custom',
      model_badge_ccb: 'CCB',
      model_badge_openai: 'OpenAI',
      model_key: 'Key:',
      model_edit: 'Edit',
      ...
      model_delete: 'Delete',
      model_select_placeholder: '-- Select Model --',
      model_select_skill_placeholder: '-- Select Skill --',
      model_streaming: 'Streaming...',
      model_testing: 'Testing...',
      model_stream_connect_prefix: 'Streaming to',
      model_connecting_prefix: 'Connecting to',
      model_stream_complete_prefix: 'Stream complete: ',
      model_empty_response: '(empty)',
      model_connection_ok: 'Connection successful',
      ...
      model_save_failed: 'Save failed',
      model_add_failed: 'Add failed',
  ...
  function _translateDynamicText(text) {
    ...
    return text.replace(_dynamicPhraseRegex, function (match) {
      return Object.prototype.hasOwnProperty.call(DYNAMIC_PHRASES, match) ? DYNAMIC_PHRASES[match] : match;
    });
  }
